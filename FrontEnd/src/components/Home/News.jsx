...
import news1 from "../../assets/assets/news/news-1.png";
import news2 from "../../assets/assets/news/news-2.png";
import news3 from "../../assets/assets/news/news-3.png";
import news4 from "../../assets/assets/news/news-4.png";
      ...
      >
        {news.map((item, index) => (
          <SwiperSlide key={index}>
            <div className="flex flex-col sm:flex-row items-center sm:items-start sm:justify-between gap-6 sm:gap-10 p-4">
              {/* content */}
